...
<body class="bg-dark text-white">
  ...
  <main>
    <div class="container mx-auto mt-5 md:p-0 px-2">
      <h1 class="text-white text-3xl md:text-5xl uppercase font-bold"><?= isset($_GET["id"]) ? "Upravit" : "Přidat" ?> autora</h1>
      <div class="text-white mt-4">
        <form class="flex flex-col gap-4" action="" method="post">
          <div>
            ...
            <input type="text" id="articleName" name="name" value="<?= isset($_GET["id"]) ? $author[0]["name"] : null ?>" class="bg-dark border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
          </div>
          <div>
            <label for="articleName" class="block mb-2 text-sm font-medium text-white">Příjmení</label>
            <input type="text" id="articleName" name="surname" value="<?= isset($_GET["id"]) ? $author[0]["surname"] : null ?>" class="bg-dark border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
          </div>
