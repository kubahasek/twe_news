    ...
    <div class="container mx-auto mt-5 md:p-0 px-2">
      ...
      <div class="text-white mt-4">
        ...
        <form class="flex flex-col gap-4 mt-4" action="" method="post">
          ...
          <button type="submit" class="text-dark bg-yellow hover:bg-violet focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Přihlásit</button>
        </form>
      </div>
  </main>
